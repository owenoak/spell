...
var lexer_public_1 = __webpack_require__(10);
...
var rest_1 = __webpack_require__(8);
var gast_public_1 = __webpack_require__(1);
var utils_1 = __webpack_require__(0);
var tokens_public_1 = __webpack_require__(2);
var first_1 = __webpack_require__(5);
...
var exceptions_public_1 = __webpack_require__(14);
var lang_extensions_1 = __webpack_require__(3);
var resolver_1 = __webpack_require__(23);
var checks_1 = __webpack_require__(21);
var utils_1 = __webpack_require__(0);
...
var tokens_public_1 = __webpack_require__(2);
var lexer_1 = __webpack_require__(24);
var utils_1 = __webpack_require__(0);
var tokens_1 = __webpack_require__(4);
...
var parser_public_1 = __webpack_require__(9);
var lexer_public_1 = __webpack_require__(10);
var tokens_public_1 = __webpack_require__(2);
var exceptions_public_1 = __webpack_require__(14);
var gast_public_1 = __webpack_require__(1);
var cache_public_1 = __webpack_require__(19);
var interpreter_1 = __webpack_require__(7);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chevrotain__ = __webpack_require__(11);
...
var _require = __webpack_require__(18),
    allTokens = _require.allTokens,
    WhiteSpace = _require.WhiteSpace,
    Plus = _require.Plus,
    Minus = _require.Minus,
    Multi = _require.Multi,
    Div = _require.Div,
    LParen = _require.LParen,
    RParen = _require.RParen,
    NumberLiteral = _require.NumberLiteral,
    AdditionOperator = _require.AdditionOperator,
    MultiplicationOperator = _require.MultiplicationOperator;

var CalculatorLexer = new __WEBPACK_IMPORTED_MODULE_0_chevrotain__["Lexer"](allTokens);

// ----------------- parser -----------------

var Calculator = function (_Parser) {
	_inherits(Calculator, _Parser);
	...
	function Calculator(input) {
		...
		var _this = _possibleConstructorReturn(this, (Calculator.__proto__ || Object.getPrototypeOf(Calculator)).call(this, input, allTokens));
		...
		__WEBPACK_IMPORTED_MODULE_0_chevrotain__["Parser"].performSelfAnalysis(_this);
	...
	_createClass(Calculator, [{
		...
		value: function canTokenTypeBeInsertedInRecovery(tokClass) {
			return tokClass !== NumberLiteral;
		}
	}]);

	return Calculator;
}(__WEBPACK_IMPORTED_MODULE_0_chevrotain__["Parser"]);
...
function calculator(text) {
	...
	if (lex.errors.length) {
		...
		try {
			for (var _iterator = lex.errors[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	if (parser.errors.length) {
		...
		try {
			for (var _iterator2 = parser.errors[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				...
				console.error(_error.name + ": " + _error.message + "\n", _error);
			}
		} catch (err) {
	...
	return { value: value, lex: lex, errors: parser.errors };
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chevrotain__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chevrotain___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_chevrotain__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdditionOperator", function() { return AdditionOperator; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Plus", function() { return Plus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Minus", function() { return Minus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MultiplicationOperator", function() { return MultiplicationOperator; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Multi", function() { return Multi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Div", function() { return Div; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LParen", function() { return LParen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RParen", function() { return RParen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NumberLiteral", function() { return NumberLiteral; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WhiteSpace", function() { return WhiteSpace; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allTokens", function() { return allTokens; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var AdditionOperator = function (_Token) {
	_inherits(AdditionOperator, _Token);

	function AdditionOperator() {
		_classCallCheck(this, AdditionOperator);

		return _possibleConstructorReturn(this, (AdditionOperator.__proto__ || Object.getPrototypeOf(AdditionOperator)).apply(this, arguments));
	}

	return AdditionOperator;
}(__WEBPACK_IMPORTED_MODULE_0_chevrotain__["Token"]);
AdditionOperator.PATTERN = __WEBPACK_IMPORTED_MODULE_0_chevrotain__["Lexer"].NA;
var Plus = function (_AdditionOperator) {
	_inherits(Plus, _AdditionOperator);
...
Plus.PATTERN = /\+/;
var Minus = function (_AdditionOperator2) {
	_inherits(Minus, _AdditionOperator2);
...
Minus.PATTERN = /-/;
var MultiplicationOperator = function (_Token2) {
	_inherits(MultiplicationOperator, _Token2);

	function MultiplicationOperator() {
		_classCallCheck(this, MultiplicationOperator);

		return _possibleConstructorReturn(this, (MultiplicationOperator.__proto__ || Object.getPrototypeOf(MultiplicationOperator)).apply(this, arguments));
	}

	return MultiplicationOperator;
}(__WEBPACK_IMPORTED_MODULE_0_chevrotain__["Token"]);
MultiplicationOperator.PATTERN = __WEBPACK_IMPORTED_MODULE_0_chevrotain__["Lexer"].NA;
var Multi = function (_MultiplicationOperat) {
	_inherits(Multi, _MultiplicationOperat);

	function Multi() {
		_classCallCheck(this, Multi);

		return _possibleConstructorReturn(this, (Multi.__proto__ || Object.getPrototypeOf(Multi)).apply(this, arguments));
	}

	return Multi;
}(MultiplicationOperator);
Multi.PATTERN = /\*/;
var Div = function (_MultiplicationOperat2) {
	_inherits(Div, _MultiplicationOperat2);
...
Div.PATTERN = /\//;
var LParen = function (_Token3) {
	_inherits(LParen, _Token3);

	function LParen() {
		_classCallCheck(this, LParen);

		return _possibleConstructorReturn(this, (LParen.__proto__ || Object.getPrototypeOf(LParen)).apply(this, arguments));
	}

	return LParen;
}(__WEBPACK_IMPORTED_MODULE_0_chevrotain__["Token"]);
LParen.PATTERN = /\(/;
var RParen = function (_Token4) {
	_inherits(RParen, _Token4);

	function RParen() {
		_classCallCheck(this, RParen);

		return _possibleConstructorReturn(this, (RParen.__proto__ || Object.getPrototypeOf(RParen)).apply(this, arguments));
	}

	return RParen;
}(__WEBPACK_IMPORTED_MODULE_0_chevrotain__["Token"]);
RParen.PATTERN = /\)/;
var NumberLiteral = function (_Token5) {
	_inherits(NumberLiteral, _Token5);
...
NumberLiteral.PATTERN = /\d*(?:\.\d+)?/;
var WhiteSpace = function (_Token6) {
	_inherits(WhiteSpace, _Token6);
...
WhiteSpace.GROUP = __WEBPACK_IMPORTED_MODULE_0_chevrotain__["Lexer"].SKIPPED;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__calculator__ = __webpack_require__(17);


console.log(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__calculator__["a" /* default */])("2 + 2"));

/***/ })
/******/ ]);
//# sourceMappingURL=app.bundle.js.map?30df8cce0d96c9561174